...
async function createTransparentImages() {
  console.log('=== Creating Transparent Background Images ===\n');
  ...
  console.log(`\n=== Transparent Image Creation Complete ===`);
  console.log(`Total processed: ${totalProcessed}`);
  console.log(`Errors: ${totalErrors}`);
}

// Run the transparent image creation
createTransparentImages().catch(console.error);
