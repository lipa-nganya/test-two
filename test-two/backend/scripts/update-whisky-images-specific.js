...
async function updateWhiskyImages() {
  try {
    ...
    const itemsToUpdate = [
      { name: 'Glenlivet Captain Reserve', url: 'https://www.dialadrinkkenya.com/search/glenlivet-captain-reserve' },
      { name: 'High Commissioner Whisky', url: 'https://www.dialadrinkkenya.com/search/high-commissioner-whisky' },
      { name: 'Isabella Islay Whisky', url: 'https://www.dialadrinkkenya.com/search/isabella-islay-whisky' },
      { name: 'Jack Daniel 700ml Corkless', url: 'https://www.dialadrinkkenya.com/search/jack-daniel-700ml-corkless' },
      { name: 'Jack Daniel\'s Honey', url: 'https://www.dialadrinkkenya.com/Jack%20Daniel\'s%20Honey%20Lemonade' },
      { name: 'Jack Daniel\'s Single Barrel', url: 'https://www.dialadrinkkenya.com/search/jack-daniel-s-single-barrel' },
      { name: 'Jack Daniel\'s Whiskey', url: 'https://www.dialadrinkkenya.com/search/jack-daniel-s-whiskey' }
    ];
