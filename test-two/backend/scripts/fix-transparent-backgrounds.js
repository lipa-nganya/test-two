...
async function fixTransparentBackgrounds() {
  console.log('=== Fixing Transparent Backgrounds ===\n');
  ...
  for (const category of categories) {
    ...
    for (const file of files) {
      try {
        ...
        // Create a new image with proper transparent background
...
// Run the transparent background fix
fixTransparentBackgrounds().catch(console.error);
