...
async function updateWineImages() {
  try {
    ...
    const itemsToUpdate = [
      { name: 'Namaqua Red Dry', url: 'https://www.dialadrinkkenya.com/search/namaqua-red-dry' },
      { name: 'Nederburg Cabernet Sauvignon', url: 'https://www.dialadrinkkenya.com/search/nederburg-cabernet-sauvignon' },
      { name: 'Nederburg Chardonnay', url: 'https://www.dialadrinkkenya.com/search/nederburg-chardonnay' },
      { name: 'Nederburg Merlot', url: 'https://www.dialadrinkkenya.com/search/nederburg-merlot' },
      { name: 'Robertson Rose', url: 'https://www.dialadrinkkenya.com/search/robertson-rose' },
      { name: 'Rosso Nobile Cioccolata', url: 'https://www.dialadrinkkenya.com/search/rosso-nobile-cioccolata' },
      { name: 'The Guv\'nor Red Wine', url: 'https://www.dialadrinkkenya.com/search/the-guv-nor-red-wine' }
    ];
