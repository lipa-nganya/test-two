...
async function updateWineImages() {
  try {
    ...
    const itemsToUpdate = [
      { name: '1659 Sauvignon Blanc', url: 'https://www.dialadrinkkenya.com/search/1659-sauvignon-blanc' },
      { name: '4th Street Red', url: 'https://www.dialadrinkkenya.com/4th-street-750ml' },
      { name: '4th Street White 5L', url: 'https://www.dialadrinkkenya.com/search/4th-street-white-5l' },
      { name: 'Asconi Red Semi Sweet', url: 'https://www.dialadrinkkenya.com/search/asconi-red-semi-sweet' },
      { name: 'Bianco Nobile', url: 'https://www.dialadrinkkenya.com/search/bianco-nobile' }
    ];
