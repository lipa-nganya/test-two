...
async function updateWhiskyImagesAndRemove() {
  try {
    console.log('🖼️  Updating whisky images and removing items...\n');
    ...
    const itemsToUpdate = [
      { name: 'Black and White Whiskey', url: 'https://www.dialadrinkkenya.com/search/black-and-white-whiskey' },
      { name: 'Bushmills Black Bush', url: 'https://www.dialadrinkkenya.com/search/bushmills-black-bush' },
      { name: 'Dalmore Valour', url: 'https://www.dialadrinkkenya.com/search/dalmore-valour' },
      { name: 'Glen Deveron 28 Years Whisky', url: 'https://www.dialadrinkkenya.com/search/glen-deveron-28-years-whisky' },
      { name: 'Glendale Whisky', url: 'https://www.dialadrinkkenya.com/search/glendale-whisky' },
      { name: 'Glenfiddich 15 Years', url: 'https://www.dialadrinkkenya.com/search/glenfiddich-15-years' }
    ];
